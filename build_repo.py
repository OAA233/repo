...
.editbtn{position:fixed;right:14px;bottom:14px;z-index:20;background:var(--accent);color:#fff;border:0;
...
body.editing .banner,body.hasdraft .banner{display:block}
"""
...
try{
  ...
  if(location.hash === "#edit") setEditable(true);
